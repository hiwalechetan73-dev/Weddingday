...
export const WEDDING_EVENTS: WeddingEvent[] = [
  {
    ...
    description: 'चला, चैतन्यमय पिवळा रंग आणि आनंदी हास्यांची उधळण करूया! सुवासिक हळदीचा लेप, जलरंग आणि मनमोहक आशीर्वादांनी वधू-वरांना न्हाऊ घालण्यासाठी आमच्यात सामील व्हा.',
    colorTheme: {
      bg: 'bg-amber-50',
  ...
  },
  {
    ...
    description: 'मंगल सुत्ताच्या दिव्य पठणाखाली आणि त्रिरत्नांच्या (बुद्ध, धम्म, संघ) पवित्र आशीर्वादाने, आम्ही आमच्या आजीवन व्रतांची शपथ घेऊ आणि आमच्या शुभ मिलनाचा सोहळा साजरा करू. त्यानंतर भव्य शाही भोजनाचा कार्यक्रम होईल.',
    colorTheme: {
      bg: 'bg-rose-50',
  ...
  },
  {
    ...
    description: 'आनंद आणि कृतज्ञतेची संध्या! पती-पत्नी म्हणून आपली पहिली संध्याकाळ दिव्य संगीत, कौटुंबिक शुभेच्छा आणि भव्य मेजवानीसह साजरी करा.',
    colorTheme: {
      bg: 'bg-emerald-50',
